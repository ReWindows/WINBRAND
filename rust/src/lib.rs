//! Windissect-generated Rust FFI bindings for WINBRAND.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "068906F10CBA0EF95E076F3D8F5F5E90";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 4122134267;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 13] = [87, 73, 78, 66, 82, 65, 78, 68, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 4122134267 { return 0; }
